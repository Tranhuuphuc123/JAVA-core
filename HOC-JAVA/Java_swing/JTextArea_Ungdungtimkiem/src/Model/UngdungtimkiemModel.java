package Model;
// mô hình MVC_úng dựng tiềm kiếm ký tự văn bản xuất hiên mấy lần
// phần Model xây dựng chưc năng quản lý xử lý dữ liệu chung

public class UngdungtimkiemModel {
    private String vanban;
    private String tukhoa;
    private String ketqua;

    // contructor
    public UngdungtimkiemModel(){
        this.vanban="";
        this.tukhoa="";
        this.ketqua="";
    }
